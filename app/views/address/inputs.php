<div class="form-group">
    <label for="name">Descrição: <sup>*</sup></label>
...
<div class="form-group">
    <label for="name">Número: <sup>*</sup></label>
...
<div class="form-group">
    <label for="name">Bairro: <sup>*</sup></label>
...
<div class="form-group">
    <label for="name">Cidade: <sup>*</sup></label>
...
<div class="form-group">
    <label for="name">Estado: <sup>*</sup></label>
...
<div class="form-group">
    <label for="name">País: <sup>*</sup></label>
